...
# yfinance по умолчанию кладёт кэш в ~/.cache, который под launchd-службой
# недоступен → "unable to open database file". Кладём кэш внутрь проекта.
_CACHE = Path(__file__).resolve().parents[2] / "data" / ".yf_cache"
